...
if ! ssh -p 40134 -i ~/.ssh/vast_ai_key root@114.32.64.6 "test -f /root/crypto_ai_trading/cache/features_cache.pkl" &>/dev/null; then
...
echo "   ssh -p 40134 -i ~/.ssh/vast_ai_key root@114.32.64.6 'tmux attach -t training'"
